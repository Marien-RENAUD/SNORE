...
#         dic_APnP = np.load(path_result + "Average_PnP_k_0/noise_"+noise+"/dict_"+str(i)+"_results.npy", allow_pickle=True).item()
...
#         dic_APnPProx = np.load(path_result + "Average_PnP_Prox_k_0/noise_"+noise+"/dict_"+str(i)+"_results.npy", allow_pickle=True).item()
