...
parser.add_argument('--fig_number', type=int, default=0)
...
if pars.fig_number == 7:
    # Generate a figure with various lanmbda and sigma for Average PnP
...
if pars.table:
    #generate the result for table of result on CBSD68 dataset.
        ...
        for j in range(m):
            ...
            if j==0:
                ...
                if j==1:
                    ...
                    ax.set_title("Deblur annealing "+str(im_name_list[j-2]), fontsize=21)
